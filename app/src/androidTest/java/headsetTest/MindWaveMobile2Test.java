...
import headsetTest.eventsTest.nskAlgo.BandPowerEventMockListener;
import headsetTest.eventsTest.nskAlgo.BlinkEventMockListener;
import headsetTest.eventsTest.nskAlgo.SignalQualityEventMockListener;
...
public class MindWaveMobile2Test {
  ...
  private final BluetoothManager bluetoothManager = new BluetoothManager();

  private final MindWaveMobile2 mindWaveMobile2 = new MindWaveMobile2(bluetoothManager,
      "deviceName");
